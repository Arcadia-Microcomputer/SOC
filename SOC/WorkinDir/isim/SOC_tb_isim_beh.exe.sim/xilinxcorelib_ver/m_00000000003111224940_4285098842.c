...
static const char *ng6 = "WARNING: Behavioral models for independent clock FIFO configurations do not model synchronization delays. The behavioral models are functionally correct, and will represent the behavior of the configured FIFO. See the FIFO Generator User Guide for more information.";
static int ng7[] = {4, 0};
static const char *ng8 = "FAILURE : Behavioral models for Virtex-4, Virtex-5, Virtex-6 and 7-Series FPGA's built-in FIFO configurations is currently not supported. Please select the structural simulation model option in CORE Generator. You can enable this in CORE Generator by selecting Project -> Project Options -> Generation tab -> Structural Simulation. See the FIFO Generator User Guide for more information.";
static const char *ng9 = "FAILURE : C_WR_PNTR_WIDTH is not log2 of C_WR_DEPTH.";
static const char *ng10 = "FAILURE : C_RD_PNTR_WIDTH is not log2 of C_RD_DEPTH.";
static const char *ng11 = "FAILURE : C_DIN_WIDTH and C_DOUT_WIDTH must be equal for ECC configuration.";
static const char *ng12 = "FAILURE : C_DIN_WIDTH and C_DOUT_WIDTH must be > 1 for double bit error injection.";
...
LAB4:    t4 = (t0 + 12440U);
    t5 = *((char **)t4);
    t4 = (t0 + 27560);
    xsi_vlogvar_wait_assign_value(t4, t5, 0, 0, 48, 100LL);
    goto LAB2;
...
LAB1:    return;
LAB3:
LAB6:    xsi_vlogfile_write(1, 0, 0, ng6, 1, t0);
    goto LAB5;

LAB7:
LAB10:    xsi_vlogfile_write(1, 0, 0, ng8, 1, t0);
    xsi_vlog_finish(1);
    goto LAB9;
...
LAB14:
LAB17:    xsi_vlogfile_write(1, 0, 0, ng9, 1, t0);
    xsi_vlog_finish(1);
    goto LAB16;
...
LAB21:
LAB24:    xsi_vlogfile_write(1, 0, 0, ng10, 1, t0);
    xsi_vlog_finish(1);
    goto LAB23;
...
LAB29:
LAB32:    xsi_vlogfile_write(1, 0, 0, ng11, 1, t0);
    xsi_vlog_finish(1);
    goto LAB31;
...
LAB47:
LAB50:    xsi_vlogfile_write(1, 0, 0, ng12, 1, t0);
    xsi_vlog_finish(1);
    goto LAB49;
...
extern void xilinxcorelib_ver_m_00000000003111224940_4285098842_init()
{
	...
	xsi_register_didat("xilinxcorelib_ver_m_00000000003111224940_4285098842", "isim/SOC_tb_isim_beh.exe.sim/xilinxcorelib_ver/m_00000000003111224940_4285098842.didat");
